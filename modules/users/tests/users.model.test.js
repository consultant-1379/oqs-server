...
describe('User Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should return the password that was entered when hashPassword is called but no salt exists', function (done) {
      var _user1 = new User(user1);
      var response = _user1.hashPassword('TestPassword');
      response.should.equal('TestPassword');
      done();
    });
  });
  ...
  describe('User E-mail Validation Tests', function () {
    ...
    it('should allow email address - "123@123.com"', function (done) {
      var _user1 = new User(user1);

      _user1.email = '123@123.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (errRemove) {
            should.not.exist(err);
